...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C100%20rows-8250df">
...
- `capital.csv` — public CSV extract (8,100 rows)
- `capital.json` — public JSON extract (8,100 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,100-row public sample | 8,100 live domains                               |
