# Available .CAPITAL One-Word Domains (8,104)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C101%20rows-8250df">
...
> **Important:** this repository is a **public 8,101-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **8,104 domains** on the canonical page below.

**Public extract:** 8,101 rows · **Live catalog:** 8,104 domains
...
- `capital.csv` — public CSV extract (8,101 rows)
- `capital.json` — public JSON extract (8,101 rows)
...
| wise.capital     | resell    | —         | —             | 98             | 72     | 4      | Sav.com, LLC    |
...
| fitness.capital  | premium   | $85.80    | $85.80        | 78             | 37     | 7      | namecheap       |
| sad.capital      | available | $9.99     | $92.99        | 72             | 27     | 3      | name.com        |
...
| ----------------------- | ------------------------------------------------ |
| 8,101-row public sample | 8,104 live domains                               |
...
> Unique Domains. *Available .CAPITAL One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
